      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px' }} navbarScroll>
            ...
            {token && profile?.role ==='ADMIN' && <Nav.Link as={Link} to="/users" className="nav-link">Users</Nav.Link>}
            {token && profile?.role ==='ADMIN' && <NavDropdown title="Trainers" id="navbarScrollingDropdown">
            
              <NavDropdown.Item href="/addtrainer">Add Trainer</NavDropdown.Item>
              <NavDropdown.Item href="/addtrainer">LBM</NavDropdown.Item>
              <NavDropdown.Item href="/addtrainer">ORM</NavDropdown.Item>
              <NavDropdown.Divider />
