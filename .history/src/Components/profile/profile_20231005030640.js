...
const Profile = () => {
  ...
  return (
    ...
    <div style={{ display: 'flex' }}> 
      ...
      <section className="bg-green text-white text-center">
  {/* Page Header Start */}
  <div className="container-fluid page-header mb-5 bg-green">
  ...
  {/* Page Header End */}
      ...
      <div style={{ display: 'flex' }}> 
        ...
        <MDBContainer className="py-4" style={{ backgroundColor: 'blue'}} >
          <MDBRow>
            <MDBCol lg="4">
