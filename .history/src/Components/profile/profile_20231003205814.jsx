...
const Profile = () => {
  ...
  return (
    <>
            ...
            <MDBCol lg="4">
              <MDBCard className="mb-4">
                <MDBCardBody className="text-center">
                  ...
                  <MDBCardImage
                  const path = '/home/naoufel/Music/gym-app-front/src/images/itachi.png'
                  src={require (  profile.path.toString) }
                  alt="avatar"
      ...
      <img
        src={require (  '/home/naoufel/Music/gym-app-front/src/images/itachi.png') }
        alt="car"
      />
