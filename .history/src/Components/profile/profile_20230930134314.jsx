...
import {profileImage} from "{profile.path}"
import {
  MDBCol,
  MDBContainer,
  MDBRow,
            ...
            <MDBCol lg="4">
              <MDBCard className="mb-4">
                <MDBCardBody className="text-center">
                  ...
                  <MDBCardImage
  src={profile.image_path} // or profile.path, depending on which property contains the image path
  alt="avatar"
...
/>
      ...
      <img
                      src="/home/naoufel/Documents/gymapp_images/profile.jpeg"
                      alt="Profile"
                      className="rounded-circle"
                      style={{
                        width: "40px",
